...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { city: @gallery.city, country: @gallery.country, name: @gallery.name, state_province: @gallery.state_province }
    end
  ...
  test "should update gallery" do
    patch :update, id: @gallery, gallery: { city: @gallery.city, country: @gallery.country, name: @gallery.name, state_province: @gallery.state_province }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
